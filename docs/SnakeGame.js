...
// include: /tmp/tmpi_ysol51.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'SnakeGame.data';
      var REMOTE_PACKAGE_BASE = 'SnakeGame.data';
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_SnakeGame.data');
      }
      Module['addRunDependency']('datafile_SnakeGame.data');
    ...
    loadPackage({"files": [{"filename": "/pipi.png", "start": 0, "end": 421}, {"filename": "/pipi_dool.png", "start": 421, "end": 1086}, {"filename": "/pipidoll.png", "start": 1086, "end": 1437}], "remote_package_size": 1437});

  })();

// end include: /tmp/tmpi_ysol51.js
// include: /tmp/tmpa6w5w9lf.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpa6w5w9lf.js
// include: /tmp/tmpr7itgy2y.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpr7itgy2y.js
...
function findWasmBinary() {
  return locateFile('SnakeGame.wasm');
}
...
var ASM_CONSTS = {
  92366: () => { if (document.fullscreenElement) return 1; },  
 92412: () => { return Module.canvas.width; },  
 92444: () => { return parseInt(Module.canvas.style.width); },  
 92492: () => { document.exitFullscreen(); },  
 92519: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 92591: () => { if (document.fullscreenElement) return 1; },  
 92637: () => { return Module.canvas.width; },  
 92669: () => { return screen.width; },  
 92694: () => { document.exitFullscreen(); },  
 92721: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 92915: () => { return window.innerWidth; },  
 92941: () => { return window.innerHeight; },  
 92968: () => { if (document.fullscreenElement) return 1; },  
 93014: () => { return Module.canvas.width; },  
 93046: () => { return parseInt(Module.canvas.style.width); },  
 93094: () => { if (document.fullscreenElement) return 1; },  
 93140: () => { return Module.canvas.width; },  
 93172: () => { return screen.width; },  
 93197: () => { return window.innerWidth; },  
 93223: () => { return window.innerHeight; },  
 93250: () => { if (document.fullscreenElement) return 1; },  
 93296: () => { return Module.canvas.width; },  
 93328: () => { return screen.width; },  
 93353: () => { document.exitFullscreen(); },  
 93380: () => { if (document.fullscreenElement) return 1; },  
 93426: () => { return Module.canvas.width; },  
 93458: () => { return parseInt(Module.canvas.style.width); },  
 93506: () => { document.exitFullscreen(); },  
 93533: ($0) => { Module.canvas.style.opacity = $0; },  
 93571: () => { return screen.width; },  
 93596: () => { return screen.height; },  
 93622: () => { return window.screenX; },  
 93649: () => { return window.screenY; },  
 93676: () => { return window.devicePixelRatio; },  
 93712: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 93765: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 93816: () => { Module.canvas.style.cursor = 'none'; },  
 93853: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94109: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94160: () => { if (document.pointerLockElement) return 1; },  
 94207: () => { if (document.fullscreenElement) return 1; },  
 94253: () => { return window.innerWidth; },  
 94279: () => { return window.innerHeight; }
};
